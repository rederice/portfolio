            ...
            <div className="flex py-6 items-center justify-center w-[100vw]">
                ...
                outline-none focus:outline-none overscroll-contain">
                    ...
                    <div className='grid grid-cols-4 gap-4 px-20 pb-16'>
                        ...
                        <div className='flex flex-col'>
                            <h3 className='text-3xl text-white py-8 font-bold tracking-[0.3rem]'>Timeline</h3>
                            <h4 className='text-white text-lg pt-6 pb-10 tracking-wider space-y-2'>
                    ...
                    <div className='px-20 pb-16'>
                        <h3 className='text-3xl text-white py-8 font-bold tracking-[0.3rem]'>Purpose of Study</h3>
                    ...
                    <div className='px-20 py-16'>
                        ...
                        <div className='flex flex-row justify-center text-white py-6'>
                             <div className='text-lg tracking-wider text-white'>
                                Redesigned Prototype&nbsp;(
                                <a className='text-[#9C82E1] underline' href='https://www.figma.com/proto/nhARB7CQvuwGY5HpGo3ZMP/TCOOC-prototype?type=design&node-id=101-221&t=CdfjtI1smK05NeWE-1&scaling=min-zoom&page-id=0%3A1&starting-point-node-id=1%3A2&mode=design'>
                                Figma Link
                                </a>
                                )
                            </div>
                        </div>
                        <div className='flex flex-row justify-center text-white text-lg pb-10 tracking-wider'> 
                            {/* image */}
                    ...
                    <div className="flex flex-row items-center justify-center p-6 border-t border-solid border-slate-200 rounded-b">                        
                        <button className='bg-blue-300 rounded-md text-black py-2 px-4 font-bold'
                        onClick={() => obj.setShowModal(false)}>
                        close
                        </button>
                    </div>
